...
/*
 * handle_char_state_using_item_ (0x80026074) — TODO one-line description.
 *
 ...
 * the .rodata carve has bytes); build the draft with `NON_MATCHING=handle_char_state_using_item_
 * ./Build`. On a full match, delete the guards and the _jtbl array.
 */

#ifndef NON_MATCHING
INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", handle_char_state_using_item_);

INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", switchD_800260b8__switchD);

INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", switchD_800260b8__caseD_0);

INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", switchD_800260b8__caseD_2);

INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", switchD_800260b8__caseD_3);

INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", switchD_800260b8__caseD_4);

INCLUDE_ASM(".shake/gen/main.exe/asm/nonmatchings/handle_char_state_using_item_", switchD_800260b8__caseD_1);
